	...
	public class BatrMenuSheet extends BatrMenuGUI implements IBatrMenuElementContainer
	{
		...
		public function appendDirectElements(...elements):IBatrMenuElement
		{
			...
			for(var i:int=0;i<elements.length;i++)
			{
				...
				if(element!=null) this._directElements.push(element);
			}
			return this;
		}
		...
		public function addChildPerDirectElements():void
		{
			for each(var element:IBatrMenuElement in this._directElements)
			{
				...
				if(element is IBatrMenuElementContainer) (element as IBatrMenuElementContainer).addChildPerDirectElements();
				if(element is DisplayObject) this.addChild(element as DisplayObject);
			}
		}
		...
		public function getElementByName(name:String):BatrMenuGUI
		{
			for each(var element:IBatrMenuElement in this._directElements)
			{
				if(element!=null&&
				   ...
				   (element as DisplayObject).name==name) return (element as BatrMenuGUI);
			}
			return null;
		}
	}
