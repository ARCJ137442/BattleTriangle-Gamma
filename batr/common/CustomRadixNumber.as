...
package batr.common;
{
	...
	public class CustomRadixNumber extends Object
	{
		...
		{
			if(isEmptyString(this._charSet)) return 0;
			return this._charSet.length;
		}
		
		public function get charSet():String
		{
			if(isEmptyString(this._charSet)) return null;
		...
		{
			//Test
			if(number==0) return getCharFromWeight(0);
			//Set
		...
		{
			//Test
			if(isEmptyString(customNumber)) return 0;
			//Set
