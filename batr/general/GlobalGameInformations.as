package batr.general 
{
	public class GlobalGameInformations 
	{
		...
		public static const GAME_UPDATE_LOG:String="Added Map_F>>>Added Gate>>>Update colorSpawner&laserTrap's color>>>Added SupplyPoint>>>New Texture of X-Trap>>>Added Arena Maps>>>Spawnpoints>>>Lower size of title>>>More stats>>>New gameMode called Hard>>>New block called Metal>>>New weapon called Lightning";
