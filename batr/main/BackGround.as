package batr.main 
{
	...
	public class BackGround extends Sprite
	{
								   ...
								   enableBorderLine:Boolean=true)
		{
			...
			if(enableGrid) updateGrid(width,height)
		...
		{
			if(this._frame==null) return false
		...
		public function updateGrid(width:uint,height:uint):void
		{
			...
			if(this._enableGrid) this.drawGrid(-GRID_SPREAD,-GRID_SPREAD,width+GRID_SPREAD*2,height+GRID_SPREAD*2);
			if(this._enableBorderLine) this.drawBorderLine(width,height);
		}
