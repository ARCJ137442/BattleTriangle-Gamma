package batr.game.entity.ai 
{
	...
	public final class AIPlayerAction 
	{
		...
		public static const TRUN_UP:AIPlayerAction=new AIPlayerAction("trunUp");
		public static const TRUN_DOWN:AIPlayerAction=new AIPlayerAction("trunDown");
		public static const TRUN_LEFT_ABS:AIPlayerAction=new AIPlayerAction("trunLeftAbs");
		public static const TRUN_RIGHT_ABS:AIPlayerAction=new AIPlayerAction("trunRightAbs");
		public static const TRUN_BACK:AIPlayerAction=new AIPlayerAction("trunBack");
		public static const TRUN_LEFT_REL:AIPlayerAction=new AIPlayerAction("trunLeftRel");
		public static const TRUN_RIGHT_REL:AIPlayerAction=new AIPlayerAction("trunRightRel");
		...
		public static function fromString(str:String):AIPlayerAction
		{
			...
			{
				if(action.name==str) return action;
			}
		...
		public static function getMoveActionFromEntityRot(rot:uint):AIPlayerAction
		{
			switch(rot)
			{
				case GlobalRot.UP:return AIPlayerAction.MOVE_UP;
				case GlobalRot.DOWN:return AIPlayerAction.MOVE_DOWN;
				case GlobalRot.LEFT:return AIPlayerAction.MOVE_LEFT_ABS;
				case GlobalRot.RIGHT:return AIPlayerAction.MOVE_RIGHT_ABS;
				default:return AIPlayerAction.NULL;
			}
		}
		...
		public static function getTrunActionFromEntityRot(rot:uint):AIPlayerAction
		{
			switch(rot)
			{
				case GlobalRot.UP:return AIPlayerAction.TRUN_UP;
				case GlobalRot.DOWN:return AIPlayerAction.TRUN_DOWN;
				case GlobalRot.LEFT:return AIPlayerAction.TRUN_LEFT_ABS;
				case GlobalRot.RIGHT:return AIPlayerAction.TRUN_RIGHT_ABS;
				default:return AIPlayerAction.NULL;
			}
		}
