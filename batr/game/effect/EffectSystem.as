package batr.game.effect 
{
	...
	public class EffectSystem
	{
		...
		public function getAllEffect():Vector.<EffectCommon>
		{
			...
			{
				if(obj!=null&&obj is EffectCommon) result.push(obj as EffectCommon);
			}
			return result;
		}
		...
		public function registerEffect(effect:EffectCommon):Boolean
		{
			...
			//UUIDMap
			if(!this.hasValidUUID(effect)) this.registerEffectforUUID(effect);
			return true
		}
		...
		public function cencellEffect(effect:EffectCommon):Boolean
		{
			...
			//UUIDMap
			if(this.hasValidUUID(effect)) this.cencellEffectforUUID(effect);
			return true
		}
